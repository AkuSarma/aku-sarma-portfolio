        ...
        <div className="animate-fadeIn space-y-6">
          ...
          <div className="flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-4 pt-4">
            <Button
              asChild
              size="lg"
              className="group bg-primary hover:bg-primary/90 text-primary-foreground shadow-lg transition-transform duration-200 hover:scale-105"
            >
              <Link href="/projects">
                View Projects{" "}
            ...
            <Button
              ...
              size="lg"
              asChild
              className="group border-primary text-primary hover:bg-primary/10 hover:text-primary shadow-lg transition-transform duration-200 hover:scale-105"
            >
              {/* Placeholder for actual resume link */}
              <a href="https://drive.google.com/file/d/1HEm3k5yqF81DWrHfTQds1b1n3dTrv9mQ/view?usp=drive_link">
                View Resume{" "}
                <FileUser className="ml-2 h-5 w-5 group-hover:animate-bounce" />
              </a>
            </Button>
          </div>
        </div>
